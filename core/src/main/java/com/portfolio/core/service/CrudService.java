package com.portfolio.core.service;

import com.portfolio.core.exception.InternalServerException;
...
public abstract class CrudService<
     ...
     */
    @Transactional
    public ResponseDto save(CreateUpdateRequestDto createDto, @NotNull AuthDetails authDetails) throws ValidationException {
        log.debug("Saving entity {}", createDto);
        Entity entity = modelMapper.map(createDto, entityClass);
        validateAuthDetails(authDetails);
        entity.setAddedBy(authDetails.getUserId());
        validate(entity);
     ...
     */
    @Transactional
    public ResponseDto update(PrimaryKey id, CreateUpdateRequestDto updateDto, @NotNull AuthDetails authDetails, Boolean isPatchRequest) throws ResourceNotFoundException, ValidationException {
        ...
        entity.setUpdatedBy(authDetails.getUserId());
        validate(entity);
        entity = repository.save(entity);
        return mapToDto(entity, responseDtoClass);
    }
    ...
    public ResponseDto delete(PrimaryKey id, @NotNull AuthDetails authDetails) throws ResourceNotFoundException {
        ...
        entity.setDeletedBy(authDetails.getUserId());
