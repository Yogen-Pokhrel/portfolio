...
public class SystemModuleController {
    ...
    @GetMapping
    @PreAuthorize("hasPermission(null, T(com.portfolio.auth.systemModule.SystemModuleAction).READ)")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasPermission(null, T(com.portfolio.auth.systemModule.SystemModuleAction).UPDATE)")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasPermission(null, T(com.portfolio.auth.systemModule.SystemModuleAction).DELETE)")
